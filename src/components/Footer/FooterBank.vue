    ...
    <div class="footer-container">
      ...
      <div class="footer-links">
        <div class="footer-links-first">
          <Button text="About Us" buttonType="button-footer" />
          <Button text="Contact" buttonType="button-footer" />
          <Button text="Blog" buttonType="button-footer" />
        </div>
        <div class="footer-links-second">
          <Button text="Careers" buttonType="button-footer" />
          <Button text="Support" buttonType="button-footer" />
          <Button text="Privacy Policy" buttonType="button-footer" />
        </div>
      </div>

      <div class="footer-request">
        <div class="footer-request-button">
          <button-request text="Request Invite" />
        </div>
...
export default defineComponent({
  name: "FooterBank",
  components: { Button, ButtonRequest },
});
</script>
...
@media (max-width: 600px) {
  ...
  .footer-links-first ,.footer-links-second {
    margin:0 auto;
  }
  .footer-links {
    width: 100%;
